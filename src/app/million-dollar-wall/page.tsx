...
export default function Page() {
    ...
    const mrrSum = allItems.reduce((sum, item) => sum + (item.amount ?? 1000), 0);
    ...
    return (
        <main className="flex h-[calc(100svh-100px)] flex-col items-center justify-center py-20 px-4">
            <h1 className="mb-4 text-4xl text-center">My Milion Dollar Wall</h1>
            ...
            <div className="flex w-full md:max-w-[600px] flex-col gap-2">
                <div className="flex justify-between">
                    <p>
                        Total {projectSum.toLocaleString("en-US", { style: "currency", currency: "USD", maximumFractionDigits: 0 })}
                    </p>
                    <p>
                        {(projectSum / 1000000 * 100).toFixed(2)}% completed
                    </p>
                    <p>
                        Avg. MRR: {avgMRR.toLocaleString("en-US", { style: "currency", currency: "USD", maximumFractionDigits: 0 })}
                    </p>
                </div>
